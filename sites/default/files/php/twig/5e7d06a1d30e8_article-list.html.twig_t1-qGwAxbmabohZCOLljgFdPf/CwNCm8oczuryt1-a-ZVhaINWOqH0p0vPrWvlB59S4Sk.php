      ...
      <img class=\"post__img\" src=\"";
            ...
            echo "</h3>
                <p class=\"post__text\">
                  ...
                  ";
            // line 53
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["article"], "field_photo", []), "entity", []), "getFileUri", [], "method")), "html", null, true);
            echo "
                    ";
            // line 54
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["article"], "body", [], "array"), 0, [], "array"), "value", [], "array")));
            echo "
...
";
    ...
    {
        return array (  193 => 59,  175 => 55,  171 => 54,  167 => 53,  161 => 50,  156 => 48,  153 => 47,  150 => 46,  147 => 45,  145 => 44,  142 => 43,  140 => 42,  137 => 41,  120 => 40,  108 => 31,  101 => 26,  86 => 24,  82 => 23,  60 => 4,  55 => 1,);
    }
      ...
      <img class=\"post__img\" src=\"{{img}}\" alt=\"\">
              <div class=\"post__content\"><span class=\"post__date\">20.02.2020</span>
                ...
                <p class=\"post__text\">
                  ...
                  {{ article.field_photo.entity.getFileUri() }}
                    {{article['body'][0]['value']|e}}
