...
class __TwigTemplate_8d4fcced6e816b1b017f4b0cf10da55750d29fecc4ce36087d06175a28dfc274 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $filters = ["escape" => 4, "raw" => 31, "striptags" => 52];
      ...
      <img class=\"post__img\" src=\"";
            ...
            echo "</h3>
                <p class=\"post__text\">
                 <div>";
            // line 52
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["article"], "body", [], "array"), 0, [], "array"), "value", [], "array"))), "html", null, true);
            echo "</div>
                </p>
   ...
   <section class=\"post\">
      ...
      <img class=\"post__img\" src=\"{{img}}\" alt=\"\">
              <div class=\"post__content\"><span class=\"post__date\">20.02.2020</span>
                ...
                <p class=\"post__text\">
                 <div>{{article['body'][0]['value']|striptags}}</div>
                </p>
